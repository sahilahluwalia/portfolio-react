...
export const Home = () => {
  ...
  const heroSection={
    heading:"About Me",
    masterText:"I am the Full Stack Developer  who turns code into magic, specializing in complex JavaScriptweb applications that will leave your users spellbound. Let's build something amazing together and make the internet a little more magical!"
  }
  return (
    <>
      <Layout>
