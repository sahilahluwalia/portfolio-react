  ...
  return (
    <>
      <p class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium lg:leading-normal cursor-pointer">
        ...
        I am the <BlueHighlight text={"Full Stack Developer"} /> who turns code
        into magic, specializing in complex{" "}
        <BlueHighlight text={"Typescript"} /> web applications that will leave
        your users spellbound. <br />
